...
- Stock not deducted from inventory when orders are placed
- Order status cannot be updated (remains "pending")
- No payment processing or simulation
- No database transactions or rollback mechanisms
- No fraud prevention or order cancellation limits
- Limited error handling and logging
- Security packages installed but not fully utilized
